      ...
      <div class="table-part-container">
        <div class="personal-information">
          <div class="information-part">
            ...
            <div class="message-part">
              <p class="message-item">被考核人
                <span class="message-detail">赵坚强</span>
              </p>
              <p class="message-item second-line">职位级别
                <span class="message-detail">高级产品经理</span>
                <span class="message-detail">M7</span>
              </p>
            </div>
        ...
        <div class="table-content">
          <div class="table-desc">
            ...
            <span class="table-score">权重：
              <span class="score-percent">40%</span>
            </span>
            <span class="table-score">统计得分：
        ...
        <div class="table-content">
          <div class="table-desc">
            ...
            <span class="table-score">权重：
              <span class="score-percent">50%</span>
            </span>
            <span class="table-score">统计得分：
              <span class="item-score">97</span>
            </span>
          </div>
        ...
        <div class="table-content">
          <div class="table-desc">
            ...
            <span class="table-score">权重：
              <span class="score-percent">加分项</span>
            </span>
            <span class="table-score">统计得分：
          ...
          <div class="data-add-button">
            <div class="btn-container">
              <i class="iconfont icon-add"></i>添加</div>
          </div>
        </div>
        <el-row>
